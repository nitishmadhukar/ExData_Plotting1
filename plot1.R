...
# plot 1: Global active power frequency across the two days
hist(required_pc$Global_active_power, main = 'Global Active Power', xlab = 'Global Active Power(kilowatts)', col = 'RED')
